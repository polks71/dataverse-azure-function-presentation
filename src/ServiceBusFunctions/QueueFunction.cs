...
public class QueueFunction
{
    ...
    public QueueFunction(ILogger<QueueFunction> logger, IOrganizationService serviceClient, IConfiguration config)
    {
    ...
    public async Task Run(
        [ServiceBusTrigger("%DataverseQueue%", Connection = "ServiceBusQueueNameSpace")]
                ...
                FunctionContext executionContext)
    {
        ...
        _logger.LogInformation($"InvocationId: {executionContext.InvocationId}");
        ...
        try
        {
            ...
            //_logger Message properties for demonstration
