...
namespace DataverseAzureFunctionsCommon.Dataverse.Model
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseAzureFunctionsCommon.Dataverse.Model.Annotation"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseAzureFunctionsCommon.Dataverse.Model.Annotation> AnnotationSet
		{
			get
			{
				return this.CreateQuery<DataverseAzureFunctionsCommon.Dataverse.Model.Annotation>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="DataverseAzureFunctionsCommon.Dataverse.Model.RjB_DemoAzureFunctionLog"/> entities.
		/// </summary>
		public System.Linq.IQueryable<DataverseAzureFunctionsCommon.Dataverse.Model.RjB_DemoAzureFunctionLog> RjB_DemoAzureFunctionLogSet
		{
			get
			{
				return this.CreateQuery<DataverseAzureFunctionsCommon.Dataverse.Model.RjB_DemoAzureFunctionLog>();
			}
		}
	}
